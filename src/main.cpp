...
int generateMTRandom(unsigned int s, int range)
{
    ...
    random::uniform_int_distribution<> dist(10000, range);
    return dist(gen);
}
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    nSubsidy += generateMTRandom(seed, 1000) * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in PumpCoin
    bool fStrictPayToScriptHash = true; // Always active in PumpCoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Yahoo News - Sunderland hits Chelsea's title hopes with 2-1 win";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x74b3ad23110c1aeeb82a94bebcb9caff861074207114bc9a08d8d07783def141"));
