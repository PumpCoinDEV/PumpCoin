...
static const int64 nTargetSpacing =  30; // PumpCoin: 30 sec
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block        
        const char* pszTimestamp = "Yahoo news 19/04/14 - Fa pipì nel bacino idrico: 143 milioni di litri d'acqua buttati via";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
