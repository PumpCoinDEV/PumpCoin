...
Intro
-----
PumpCoin is a free open source project derived from NovaCoin, with
...
incoming connections.  PumpCoin works without incoming connections,
but allowing incoming connections helps the PumpCoin network.
